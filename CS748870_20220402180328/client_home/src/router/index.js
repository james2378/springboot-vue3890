...
const routes = [
	...
	//路线申请添加路由
	{
		path: '/route_application/edit',
		name: '/route_application_edit',
		component: () => import('../views/route_application/edit.vue')
	},
...
router.afterEach((to, from, next) => {
	let title = "汉中旅游资源信息系统-home";
	document.title = title;
	document.logo = "汉中旅游资源信息系统"
})
