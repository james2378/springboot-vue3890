		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			<el-col v-if="user_group === '管理员' || $check_field('get','scenic_spot_type') || $check_field('add','scenic_spot_type') || $check_field('set','scenic_spot_type')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="景点类型" prop="scenic_spot_type">
					<el-input id="scenic_spot_type" v-model="form['scenic_spot_type']" placeholder="请输入景点类型"
							  v-if="user_group === '管理员' || (form['type_management_id'] && $check_field('set','scenic_spot_type')) || (!form['type_management_id'] && $check_field('add','scenic_spot_type'))" :disabled="disabledObj['scenic_spot_type_isDisabled']"></el-input>
